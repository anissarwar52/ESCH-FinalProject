...
export default function ShopLogin() {
  ...
  const loginShopkeeper= async (e)=>{
    e.preventDefault();
    
    const res = await fetch("/shopkeeper/signin",{
      method: "POST",
      headers:{
    ...
    <div className="container-fluid bg-dark">
        ...
        <div className="jumbotron jumbotron-fluid mb-5">
          <div className="container text-center py-5">
            <h1 className="text-white display-3">Shopkeeper Login</h1>
            <div className="d-inline-flex align-items-center text-white">
              ...
              <p className="m-0">Shopkeeper Login</p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
            <div className="row">
        <div class="col-lg-7"><h6 class="text-primary text-uppercase font-weight-bold">Login As Shopkeeper</h6>
