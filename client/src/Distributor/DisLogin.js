...
import DisLoginImg from '../Images/DisLoginImg.png';
import '../App.css';
...
export default function DisLogin() {
  ...
  const loginDistributor= async (e)=>{
    e.preventDefault();
    
    const res = await fetch("/distributor/signin",{
      method: "POST",
      headers:{
    ...
    <div className="container-fluid bg-dark">
        ...
        <div className="jumbotron jumbotron-fluid mb-5">
          <div className="container text-center py-5">
            <h1 className="text-white display-3">Distributor Login</h1>
            <div className="d-inline-flex align-items-center text-white">
              ...
              <p className="m-0">Distributor Login</p>
            </div>
          </div>
        </div>
        ...
        <div className="container">
            <div className="row">
        <div class="col-lg-7"><h6 class="text-primary text-uppercase font-weight-bold">Login As Distributor</h6>
        ...
        <div className='container mt-6'>
            ...
            <div className="signin-image">
                    <figure>
                        <img src={DisLoginImg} alt="registration Pic" />
                    </figure>
