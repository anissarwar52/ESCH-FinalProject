...
const FeaturedD = () => {
  const [target, setTarget] = useState(10); // Set your target revenue here
  ...
  useEffect(() => {
    ...
    fetch('/distributor/lastWeekSales')
      .then((response) => response.json())
    ...
    fetch('/distributor/lastMonthSales')
      .then((response) => response.json())
  ...
  return (
    <div className="featured">
      ...
      <div className="bottom">
        ...
        <p className="amount">{todayEarnings} Sales</p>
        <p className="desc">
        ...
        <div className="summary">
          <div className="item">
            ...
            <div className="itemResult negative">
              ...
              <div className="resultAmount">{target} Sales</div>
            </div>
          </div>
          <div className="item">
            ...
            <div className="itemResult positive">
              ...
              <div className="resultAmount">{lastWeekEarnings} Sales</div>
            </div>
          </div>
          <div className="item">
            ...
            <div className="itemResult positive">
              <KeyboardArrowUpOutlinedIcon fontSize="small" />
              <div className="resultAmount">{lastMonthEarnings} Sales</div>
            </div>
          </div>
        </div>
      </div>
