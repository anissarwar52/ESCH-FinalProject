...
const DisOrderHistory = () => {
  ...
  useEffect(() => {
    ...
    fetch('/distributor/orders/history')
  ...
  const handleAcceptOrder = (orderId) => {
    ...
    fetch(`/distributor/orders/${orderId}`, {
      method: 'PUT',
      credentials: 'include',
      headers: {
                ...
                <TableBody>
                  {orders.map((item) => (
                    <TableRow key={item._id}>
                      ...
                      <TableCell className="tableCell">{item.shop}</TableCell>
                      ...
                      <TableCell className="tableCell">
                        <Link to={`/distributor/orders/history/${item._id}`} className="detailLink">Details</Link>
                      </TableCell>
                    </TableRow>
                  ))}
                </TableBody>
